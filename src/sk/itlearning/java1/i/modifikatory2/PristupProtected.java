...
public class PristupProtected extends TriedaPublic {
	...
	public static void main(String[] args) {
		...
		PristupProtected p3 = new PristupProtected();
		p3.premennaProtected = "ok"; 	// tentokrat ok, trieda PristupProtected je dedicom TriedaPublic a ma pristup
										// aj ku protected clenom v inom package

		// toto nie, pristup ma iba potomok
		//p2.premennaProtected = "ok";
